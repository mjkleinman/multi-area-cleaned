...
p.add_argument('-g', '--gpus', nargs='?', type=int, const=1, default=3)
p.add_argument('-lambdar', '--lambdar', type=float, default=None)
p.add_argument('-lambdaw', '--lambdaw', type=float, default=None)
p.add_argument('-lr', '--lr', type=float, default=None)
...
#=========================================================================================
    ...
    # Train
    model.train(savefile, seed=seed, compiledir=compiledir, gpus=gpus, lambdar=lambdar, lambdaw=lambdaw, lr=lr)
