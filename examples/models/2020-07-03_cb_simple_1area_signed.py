...
# Network structure
# =================
Nin = 2  # number of inputs; #left target, #right target, red coh, green coh
...
def generate_trial(rng, dt, params):
    ...
    if not catch_trial:
        X[e['targets'], 0] = 0  # this is the identity of the left target: -1 is red, +1 is green
        X[e['targets'], 1] = 0  # this is the identity of the right target

        X[e['check'], 2] = coh(cond) * correct_choice  # coherence of red
        X[e['check'], 3] = coh(225 - cond) * correct_choice  # coherence of green
